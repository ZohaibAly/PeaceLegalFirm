    ...
    <div className="w-full max-w-[1450px] mx-auto px-4 py-22">
      ...
      <div className="flex flex-col gap-0 items-center justify-center custom800:flex-row custom800:items-start custom800:justify-start">
        ...
        <div className="w-full custom800:w-1/2 order-2">
          ...
          >
            <p>
              Peace International law firm One a dream has been structured into
              a reality. This has taken an enduring over 11 years of conviction
              and untiring efforts to see it grow into a leading Law Firm with
              one of biggest market clientage within the country especially in
              Lahore and abroad. The Firm has seen transformation from
              conventional to state of art and highly Mechanized & scientific
              Litigation.
            </p>

            <p>
              Its an Era of Scientific achievement, where hearts and minds are
              controlled by machines but significance of Law is essence of all
              Eras till infinite, as per current Era is concerned we stand firm
              to maintain our composure through expeditious & dedicated services
              to our clients, we feel relaxed when we busy working hard.
            </p>

            <p>
              Peace law firm is cleansed from Bossy atmosphere and its
              administrative affairs are controlled with sense of responsibility
              and realization of each member of Team. Peace law is Primarily a
              legal Research Institute/Organization thus each and every brief of
              case is considered as research material and all efforts and
              struggles are use to achieve successful results for our clients.
            </p>
          </div>
