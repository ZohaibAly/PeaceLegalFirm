          ...
          {stats.map((stat, index) => (
            <React.Fragment key={index}>
              <div className="flex flex-col items-center text-center min-w-40 max-w-[360px]">
                <div className="mb-3">
                  <img src={stat.icon} alt={stat.label} className="w-12 h-12 md:w-16 md:h-16 mx-auto" />
                </div>
                
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-1 md:mb-2" style={{ fontFamily: theme.fonts.heading }}>
                  {stat.number}
                </h2>
                
                <p className="text-sm md:text-base lg:text-lg" style={{ fontFamily: theme.fonts.body }}>
                  {stat.label}
                </p>
              </div>
