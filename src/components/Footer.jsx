...
const Footer = () => {
  const { logoSrc, description, columns, newsletter, copyright, contactEmail  } = footerData;
    ...
    <section className="py-6 bg-linear-to-b sm:pt-20 lg:pt-28 ">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-[1650px] ">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          ...
          {/* Company Column */}
          <div>
            <p className="text-[18px] font-bold tracking-widest uppercase mb-6"
               style={{
...
<div className="flex justify-between items-center flex-wrap">
  <p
    ...
    style={{ fontFamily: theme.fonts.body }}
  >
    <Copyright size={18} aria-hidden="true" style={{color:theme.colors.primary}}  />
    {copyright}
  </p>

 <p className="flex items-center gap-1">
  <Mail size={18} aria-hidden="true" style={{ color: theme.colors.primary }} />
  <a
