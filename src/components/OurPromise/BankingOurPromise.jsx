...
export default function BankingOurPromise() {
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-8">
          ...
          >
            ...
            <div className="text-center">
              ...
              >
               Every case is handled with honesty and open communication.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="text-center">
              ...
              >
                We treat your case with priority and strategic focus.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="text-center">
              ...
              >
                Our goal is to secure the best possible outcome.
              </p>
            </div>
          </div>
        </div>
