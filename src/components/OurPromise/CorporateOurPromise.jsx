...
export default function CorporateOurPromise() {
      ...
      <div className="relative z-10 w-full max-w-[1450px] mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-8">
         ...
         Efficiency & Accuracy:
              ...
              >
               We handle all corporate and NOC matters with precision and professionalism.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="text-center">
              ...
              >
           Expert legal support to keep your business compliant and protected.
              </p>
            </div>
          </div>
        ...
        Commitment to Excellence:
              ...
              >
               Focused on delivering fast, reliable, and results-oriented solutions for all your corporate needs.
              </p>
            </div>
          </div>
        </div>
